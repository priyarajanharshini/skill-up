     ...
     <div className="container mx-auto mt-4">
      <div className="flex flex-col relative items-center gap-6 mt-12 sm:mt-20 md:mt-20 lg:mt-20 overflow-hidden">
        <div className="flex flex-col items-center">
          ...
          <p className="font-outfit text-lg sm:text-xl md:text-xl lg:text-xl w-full font-regular leading-8 sm:leading-8 text-center text-black mt-4 sm:mt-6 p-1 sm:px-8 md:px-16 px-8 lg:px-1">
