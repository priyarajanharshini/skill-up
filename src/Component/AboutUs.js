...
const AboutUs = () => {
  return (
    <>
      <div className="flex flex-col relative items-center gap-6 mt-14 overflow-hidden">
        <div className="flex flex-col items-center">
          <h1 className="font-clash text-4xl sm:text-5xl font-semibold leading-48px sm:leading-67.2px text-center w-280px sm:w-831px h-auto sm:h-67px gap-0">
            About <span className="text-sky-blue">us</span>
          </h1>
          <p className="font-outfit text-lg sm:text-2xl w-full font-light leading-6 sm:leading-8 text-center p-1 text-black xz:px-120px sm:px-120px md:px-20 lg:px-40">
            Our mission is to accelerate your career and help you explore new technologies.
          </p>
        </div>
        {/* <div className="relative  container w-[380px] sm:w-[540px] md:w-[720px] lg:w-[1080px] h-[200px] sm:h-[300px] md:h-[400px] lg:h-[500px] mx-auto"> */}
        <div className=" container relative w-96 lg:w-10/12 md:w-9/12 sm:w-4/5 rounded-40px overflow-hidden mx-auto p-2">
          <img className="w-full h-full rounded-2xl	 sm:rounded-3xl md:rounded-28px lg:rounded-32px object-cover" src={aboutusvideo} alt="Outer" />
            ...
            <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 px-2 mb-8">
              <div class="border border-white-100 shadow-custom-box rounded-3xl p-0.5">
                <div class="bg-[#e7f4ff] p-10 rounded-3xl mx-auto text-center h-40">
                  <p class="font-clash text-5xl font-semibold leading-72 text-left">15,630+</p>
