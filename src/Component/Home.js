            ...
            <div className="container mx-auto mt-4">
                ...
                <div className="mx-auto  mt-12 sm:mt-20 md:mt-20 lg:mt-20  text-center">
                    <div className="flex justify-center mb-4">
                        <button className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-md h-14 bg-white-500 text-black border border-gray-500 font-bold rounded-full flex items-center justify-between px-4 sm:px-12 md:px-8 lg:px-12">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute inset-y-0 top-14 right-4 lg:-top-24 sm:right-8 sm:-top-24 md:right-10 md:-top-24 lg:right-12">
                    ...
                    <div className="text-center mt-14 mx-4 sm:mx-4">
                        <p class="tracking-tighter px-4 font-clash font-bold text-5xl sm:text-5xl md:text-6xl lg:text-6xl leading-tight">
                            Specialize in<span class="text-blue-600 tracking-tighter"> high-demand </span>
                        </p>
                        <p className="px-4 font-clash font-medium text-5xl sm:text-5xl md:text-6xl lg:text-6xl leading-tight lg:leading-snug">
                            technical courses
                        </p>
                    </div>
