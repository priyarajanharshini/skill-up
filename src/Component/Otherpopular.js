                ...
                <div className="shadow-xl rounded-3xl overflow-hidden border-2 border-white h-full p-4 m-4 bg-custom-lightgray">
                  <div className="relative">
                    ...
                    <div className="w-88px h-12 rounded-xl p-2 bg-white absolute bottom-0 right-0 mr-6 mb-6 flex items-center justify-center">
                      ...
                      <span className="font-semibold text-xl text-orange">4.8</span>
                    </div>
                  </div>
                  <div className="mt-4">
                  <div className="h-14 overflow-hidden">
                    ...
                    <div className="flex items-center mt-6">
                      ...
                      <p className="ml-4 font-clash font-semibold text-xl leading-none">{course.AuthorName}</p>
                    </div>
                    <div className="flex justify-between items-center mt-6">
                      <div className="flex items-center">
                        <img className="w-6 h-6" src={clock} alt="Clock" />
                        <span className="ml-2 font-normal lightgray outfit">{course.TotalDuration.hours}hr{course.TotalDuration.minutes}min</span>
                      </div>
                      <div className="flex items-center">
                        <img className="w-6 h-6" src={profile} alt="Profile" />
                        <span className="ml-2 text-gray-500">{course.TotalReviews}</span>
                      </div>
                    </div>
                  </div>
                </div>
